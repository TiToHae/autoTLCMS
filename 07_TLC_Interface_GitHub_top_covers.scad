...
module nuc_old(){
        difference(){
            union(){
            ////srewposts
                translate([ 47.5, 45.5,-4]) cylinder(h=5, r=5,$fn=60);  
                translate([-47.5,-45.5,-4]) cylinder(h=5, r=5,$fn=60);  
                translate([-47.5, 45.5,-4]) cylinder(h=5, r=5,$fn=60);  
                translate([ 47.5,-45.5,-4]) cylinder(h=5, r=5,$fn=60);
            ////baseplate
                hull(){       
                    translate([ 45.5, 43.5,-1.5]) cylinder(h=5, r=8,$fn=60);  
                    translate([-45.5,-43.5,-1.5]) cylinder(h=5, r=8,$fn=60);  
                    translate([-45.5, 43.5,-1.5]) cylinder(h=5, r=8,$fn=60);  
                    translate([ 45.5,-43.5,-1.5]) cylinder(h=5, r=8,$fn=60);
                }                  
            ////arduino postes
                translate([-38.5, 21,0.5]) cylinder(h=5, r=2.5,$fn=60); 
                translate([-37.5,-27,0.5]) cylinder(h=5, r=2.5,$fn=60); 
                translate([ 45.5, 21,0.5]) cylinder(h=5, r=2.5,$fn=60); 
                translate([ 37.5,-27,0.5]) cylinder(h=5, r=2.5,$fn=60); 
            ////main hull
                difference(){
                    hull() {
                        translate([ 49.5, 47.5,0]) cylinder(h=10, r=8,$fn=60);  
                        translate([-49.5,-47.5,0]) cylinder(h=10, r=8,$fn=60);  
                        translate([ 49.5,-47.5,0]) cylinder(h=10, r=8,$fn=60);  
                        translate([-49.5, 47.5,0]) cylinder(h=10, r=8,$fn=60);
                    } 
                    hull(){
                        translate([ 45.5, 43.5,-1]) cylinder(h=72, r=8,$fn=60);  
                        translate([-45.5,-43.5,-1]) cylinder(h=72, r=8,$fn=60);  
                        translate([ 45.5,-43.5,-1]) cylinder(h=72, r=8,$fn=60);  
                        translate([-45.5, 43.5,-1]) cylinder(h=72, r=8,$fn=60);
                    }       
            ...
            ////srewhead cutout
                ...
                translate([ 47.5,-45.5,1]) cylinder(h=5, r=5,$fn=60);  
            ////srew cutout
                translate([ 47.5, 45.5,-6]) cylinder(h=10, r=2.5,$fn=60);  
                translate([-47.5,-45.5,-6]) cylinder(h=10, r=2.5,$fn=60);  
                translate([-47.5, 45.5,-6]) cylinder(h=10, r=2.5,$fn=60);  
                translate([ 47.5,-45.5,-6]) cylinder(h=10, r=2.5,$fn=60);     
            ////sidecutouts
                hull(){
                    translate([-40, 51.5,-1.6]) cylinder(h=1.6, r=2,$fn=60);  
                    translate([ 40, 51.5,-1.6]) cylinder(h=1.6, r=2,$fn=60);
                }       
                hull(){
                    translate([-40,-51.5,-1.6]) cylinder(h=1.6, r=2,$fn=60);  
                ...
                hull(){
                    translate([ 53.5,-40,-1.6]) cylinder(h=1.6, r=2,$fn=60);  
                    translate([ 53.5, 40,-1.6]) cylinder(h=1.6, r=2,$fn=60);
                }         
                hull(){
                    translate([-53.5,-40,-1.6]) cylinder(h=1.6, r=2,$fn=60);  
            ...
            ////main cutout
                hull() {
                    translate([ 26, 40,-10]) cylinder(h=20, r=6,$fn=60);  
                    translate([-26,-40,-10]) cylinder(h=20, r=6,$fn=60);  
                    translate([-26, 40,-10]) cylinder(h=20, r=6,$fn=60);  
                    translate([ 26,-40,-10]) cylinder(h=20, r=6,$fn=60);
                }   
            ////arduino srews cutout
        translate([-38.5, 21,0]) cylinder(h=160, r=0.95,$fn=60); 
        translate([-37.5,-27,0]) cylinder(h=160, r=0.95,$fn=60); 
        translate([ 45.5, 21,0]) cylinder(h=160, r=0.95,$fn=60); 
        translate([ 37.5,-27,0]) cylinder(h=160, r=0.95,$fn=60);
    }
 }   
